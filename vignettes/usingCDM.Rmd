...
```
Set up covariate setting and plpData (adapated from The book of OHDSI chapter 13 and Appendix E.9)
```{r}
...
resultsExternal <- withCallingHandlers({
