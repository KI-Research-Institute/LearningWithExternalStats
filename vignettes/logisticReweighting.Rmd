...
and display results:
```{r, message=FALSE, warning=FALSE, eval=TRUE}
showResults <- rownames(estimatedResults$estimation) %in% c('AUROC', 'AUROC 0.025', 'AUROC 0.975' ,'n', 'n outcome', 'Brier score')
print(format(estimatedResults$estimation[showResults, ], digits=3))
```
