...
```{r message=FALSE, warning=FALSE, eval=TRUE}
  ...
  internalPerf <- internalResults$performanceEvaluation$evaluationStatistics
  displayRows <- (internalPerf['evaluation']=='Test') & (internalPerf[['metric']] %in% plpMetrics)
  cat('Internal performance:\n')
  print(format(internalPerf[displayRows, c('metric', 'value')], digits=3))
  
  externalPerf <- externalResults[[2]]$performanceEvaluation$evaluationStatistics
  displayRows <- (externalPerf['evaluation']=='Validation') & (externalPerf[['metric']] %in% plpMetrics)
  cat('External performance:\n')
  print(format(externalPerf[displayRows, c('metric', 'value')], digits=3))
