...
#' Anchor binary data 1
#' @docType data
#' @keywords datasets
#' @name binaryAnchorData1
#' @format A named list containing the following elements:
#' \describe{
#'   \item{internalTrain}{A data frame of internal training set}
#'   \item{internalTest}{A data frame of internal test set}
...
#' Anchor logistic regression model 1 with binary covariates
#' @docType data
#' @keywords datasets
#' @name binaryAnchorLR1
#' @format A logistic regression model trained using binaryAnchorData1::internalTrain
#' @usage
#' binaryAnchorLR1
NULL
